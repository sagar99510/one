...
<body>
	...
	<h1 style="color: purple; font-size: 40px;" align="center">Integration done by Karthik</h1>
        <h2 style="color: orange; font-size: 40px;" align="center">Senior DevOps Engineer</h2>
        <h2 style="color: Black; font-size: 40px;" align="center">From Nokia</h2>
